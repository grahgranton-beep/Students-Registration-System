...
import { GraduationCap, User, Mail, Lock, Phone, UserCheck, Calendar, Hash } from 'lucide-react';
    ...
    <div style={{
      ...
      <div className="glass-panel animate-fade-in" style={{
        ...
        <div style={{ textAlign: 'center', marginBottom: '2rem' }}>
          ...
          <h2 style={{ fontSize: '1.5rem', fontWeight: 800, color: 'white', marginBottom: '0.25rem' }}>Student Self-Service Registration</h2>
          <p style={{ fontSize: '0.85rem', color: 'var(--text-secondary)' }}>Create your student portal account to enroll for academic courses</p>
        </div>
